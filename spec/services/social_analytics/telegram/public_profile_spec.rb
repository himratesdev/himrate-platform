  ...
  describe ".parse" do
    let(:html) do
      page(subs: "236K", posts: [
        [ "70K", "2026-07-08T12:00:00+00:00" ],
        [ "60K", "2026-07-09T12:00:00+00:00" ],
        [ "50K", "2026-07-10T12:00:00+00:00" ],
        [ "40K", "2026-07-11T12:00:00+00:00" ]
      ])
    end

    it "extracts subscribers, title, posts and derived metrics" do
