...
module TrustIndex
  module Signals
    class TiDropDetector
      ...
      # Basis = `authenticity` (0-100, same scale/semantics as the old TI for drop purposes);
      # EC-15 GREY rows carry authenticity NULL and are excluded (nil→0.0 would fake a 90-pt drop).
