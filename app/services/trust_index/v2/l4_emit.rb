    ...
    class L4Emit
      ...
      def call
        ...
        EmitResult.new(
          ...
          confirmed_anomaly: c_hard || c_self, cold_start_tier: @c.cold_start_tier,
      ...
      def band_drivers
        BandClassifier::Drivers.new(
          ...
          raid_window: @c.raid_window, cold_start_tier: @c.cold_start_tier
        )
      end

      def reason_ctx
        ReasonCodeBuilder::Ctx.new(
          c_hard: c_hard, c_self: c_self, named_count: @c.named_count, named_pct: (n_frac * 100.0).round(1),
