...
module Clickhouse
  # TASK-251.14c (post-PR-1e-B): single source of truth for the parsed-record → ClickHouse
  # chat_messages row mapping. Sole live caller: ChatMessageWorker#write_to_clickhouse (live
  # IRC ingest, symbol-keyed hash from parse_message). Accepts either symbol or string keys
  # via with_indifferent_access for caller flexibility. Coalesces nils to non-nullable column
