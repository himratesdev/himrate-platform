...
# TASK-A1 FR-015 (philosophy-v2): Daily rollup aggregation per channel.
# Source of truth для Trends API. Заполняется Trends::AggregationWorker
...
class TrendsDailyAggregate < ApplicationRecord
  ...
  # v3 = philosophy-v2 (post-TASK-201 + TASK-A1 FR-035): dropped
