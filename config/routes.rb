...
Rails.application.routes.draw do
  ...
  constraints host: "app.himrate.com" do
    ...
    get "business/new", to: "pages#business_new"
  ...
  # robots.txt is host-aware (app host = crawl allowed, deindexed by noindex; WEB-CONSOLIDATION
  # stand = Disallow all; every other host = the marketing policy); served from PagesController.
  ...
  # Business-account application (screen 72) — standalone onboarding form.
  get "app/business/new", to: "pages#business_new"
