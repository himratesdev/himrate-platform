...
`AutoRemediation::TriggerService` uses `AUTO_TRIGGER_GH_PAT` (fine-grained PAT, scope: actions:write на himrate-platform). Sidekiq retry с backoff handles transient errors.
